		...
		<div class="row my-5">
			...
			<div class="register-formbg loginwindow">
				<div class="thim-login form-submission-register custom-form loginonly fgot">
				  <div class="sc_heading   text-center " style="padding: 0px 0 0;margin-bottom:0px;"><h2 class="title" style="margin: 0;font-size: 18px;text-align: left;background: #263a7d;padding: 8px;color: #fff;"><?php echo $section_name; ?></h2></div>
