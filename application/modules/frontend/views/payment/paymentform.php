        ...
        <form action="#" id="payment_form">
          ...
          <div class="dv">
            <div class="form-group"> <span>
              <input type="hidden" id="hash" name="hash" placeholder="Hash" value="" class="form-control" />
              </span> </div>
          </div>
          <?php /*
					<div class="row">
            ...
            <div class="numbersssdtf">
              <div class="active-screen">
                <div class="number-account"> <span class="number one"> <a href="<?php echo base_url().'create_ticket/?catid='.$ticketformdata['urlcatid'];?>"><i class="fa fa-file-text" aria-hidden="true"></i></a> </span> <span class="text-part"> Create Ticket </span> </div>
                <?php 
								$usersession 	= $this->session->userdata('users');
								if(empty($usersession)){
						   ?>
                <div class="number-account"> <span class="number two"> <a href="javascript:void(0);"><i class="fa fa-sign-in" aria-hidden="true"></i></a> </span> <span class="text-part"> Login / Registration </span> </div>
                <?php } ?>
                <div class="number-account"> <span class="number three active"> <a href="<?php echo base_url().'payment';?>"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a> </span> <span class="text-part active"> Confirmation </span> </div>
                <div class="number-account"> <span class="number four"> <a href="javascript:void(0);"><i class="fa fa-list-ul" aria-hidden="true"></i></a> </span> <span class="text-part"> Review </span> </div>
              </div>
            </div>
                ...
                <div class="formares">
                  ...
                  <div class="row">
                    <div class="col-md-6 havwesomeadon">
                      <div class="form-group inputBox focus"> <?php echo form_label('Mobile Number*', 'customer_mobile'); ?>
                        <div class="input-group"> <span class="input-group-addon" id="sizing-addon1">+91</span>
                          <?php
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="mt-5">
                        ...
                        <div class="form-group inputBox focus"> <?php echo form_label('Uploaded Document', 'image'); ?>
                          ...
                          <?php 
									...
									?>
                          <a href="<?php echo base_url().'uploads/ticket/'.$alluploadedfile->file; ?>" target="_blank"><?php echo $alluploadedfile->filename; ?></a>
                          <?php if($allfiles > $counter ){ echo ' ,';} ?>
                          <?php $counter++;} ?>
                          <?php }else{ ?>
                          <p style="font-size:12px;">No document uploaded.</p>
                          <?php } ?>
                        </div>
                      </div>
                    </div>
...
<div class="row">
                ...
                <p style="font-size: 13px; margin: 5px 0 0">
                  <input type="checkbox" name="terms" tabindex="17" required="required" id="terms">
              ...
              <div class="col-md-12" style="margin-top: 15px">
                <div class="form-group col-12"> <a class="btn btn-danger" href="<?php echo base_url().'create_ticket/?catid='.$ticketformdata['urlcatid'];?>">Edit Ticket Form</a>
