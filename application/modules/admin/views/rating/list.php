                ...
                <div class="card">
                    ...
                    <div class="card-body">
						...
						<div class="table-responsive customizetableres">
							<table id="rating_table_id" class="table table-bordered table-striped" style="width: 100%">
								<thead>
									<tr>
										<th>#</th>
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td><span style="word-break: break-all; display: block; width:108px; word-wrap: break-word;"><?php echo !empty($catname)?$catname:'NA';?></span></td>     
											<td><span style="word-break: break-all; display: block; width:108px; word-wrap: break-word;"><?php echo !empty($subcatname)?$subcatname:'NA';?></span></td>     
