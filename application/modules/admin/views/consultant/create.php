                ...
                <div class="card">
                    ...
                    <div class="card-body floating-laebls">
						...
						<div class="row">
							<div class="col-6">
								<?php 
									$user_name_focus 	= !empty($postdata['user_name'])?"focus":"";
								?>
							...
							<div class="col-6">
								<?php 
									$sname_focus 	= !empty($postdata['user_name'])?"focus":"";
								?>
						...
						<div class="row">
							<div class="col-6">
								<?php 
									$email_focus = !empty($postdata['user_email'])?"focus":"";
								?>
							...
							<div class="col-6">
								<?php 
									$mobile_focus = !empty($postdata['user_mobile'])?"focus":"";
								?>
								<div class="form-group inputBox <?php echo $mobile_focus; ?>">
									<?php
										echo form_label('Mobile Number <span class="required">*</span>', 'user_mobile');
										echo form_input(array('name' => 'user_mobile', 'class' => 'form-control input','id' => 'user_mobile', 'value' => set_value('user_mobile'), 'maxlength' => '14'));
							...
							<div class="col-6">
								<div class="form-group inputBox focus">
									<?php
										...
										echo form_dropdown('user_country',$option,$selected=set_value('user_country',DEFAULT_COUNTRY),$extra='class="form-control select-state input" data-section="user_state" data-stateid="'.DEFAULT_STATE.'" id="user_country" disabled="disabled"');
							...
							<div class="col-6">
								<div class="form-group inputBox focus">
									<?php
										...
										echo form_label('City <span class="required">*</span>', 'user_city');
										$allcity      	= [];
										$allcity['']  	= 'Select City';
										if(!empty($cityquery)){
						...
						<div class="row">
							<div class="col-6">
								<?php 
									$pin_focus = !empty($postdata['pin_code'])?"focus":"";
								?>
							...
							<div class="col-6">  
								<?php 
									$address_focus = !empty($postdata['user_address'])?"focus":"";
								?>
