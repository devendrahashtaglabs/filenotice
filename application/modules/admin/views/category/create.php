		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<?php
						echo form_open_multipart($pageUrl, array('class' => 'create_category', 'id' => 'CategoryForm'));
					?>
					<div class="card-body floating-laebls">
							...
							<div class="col-6">                            
								<div class="form-group inputBox focus">
									...
									echo form_dropdown('cat_status', $options = array(
										...
										'1' => 'Active',
										'0' => 'Inactive',
											), $selected = set_value('cat_status'), $extra = 'class="form-control input",id="cat_status"');
						...
						<div class="row">
						   <?php /* <div class="form-group col-6">
								...
								echo form_input(array('name' => 'amount', 'class' => 'form-control', 'value' => set_value('amount'), 'id' => "amount", 'placeholder' => 'Amount', 'maxlength' => '5'));
							...
							<div class="col-6">                            
								<div class="form-group inputBox">
									<?php
										...
										echo form_input(array('name' => 'cat_icon', 'class' => 'form-control input', 'value' => set_value('cat_icon'), 'id' => "cat_icon"));
									?>
										<p>Find new class name <a href="https://fontawesome.com/v4.7.0/icons/" target="_blank">Click Here</a></p>
									<?php echo '<div class="error-msg">' . form_error('cat_icon') . '</div>';
									?>
								</div>
							</div>
							<div class="col-6">                            
						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									<?php
										echo form_submit(array("class" => "btn btn-primary", "id" => "creatre_cat_btn", "value" => "Submit"));
