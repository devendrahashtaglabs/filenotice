        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <?php echo form_open($pageUrl, array('class' => 'create_expertise', 'id' => 'ExpertiseForm')); ?>
                            ...
                            <div class="col-6">                            
								<div class="form-group inputBox">
									<?php
										...
										echo form_input(array('name' => 'exp_name', 'class' => 'form-control input', 'value' => set_value('exp_name'), 'id' => "exp_name"));
								...
								<div class="form-group inputBox focus">
									<?php 
										...
										echo form_dropdown('exp_status', $options=array(
											...
											'1'=>'Active',
											'0'=>'Inactive'
										), $selected=set_value('exp_status'),$extra ='class="form-control input",id="exp_status"');
						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									<?php
										echo form_submit(array("class" => "btn btn-primary", "id" => "creatre_exp_btn", "value" => "Submit"));
