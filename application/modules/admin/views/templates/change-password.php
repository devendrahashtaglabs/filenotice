                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-7">
                                    ...
                                    echo form_password(array('name' => 'old_password', 'class' => 'form-control', 'value' => set_value('old_password'), "placeholder" => "Current Password"));
                                ...
                                <div class="form-group col-7">
                                    ...
                                    echo form_input(array('name' => 'confirm_password', 'class' => 'form-control', 'value' => set_value('confirm_password'), 'placeholder' => 'Confirm Password'));
                                ...
                                <?php
                                    ...
                                    echo '&nbsp;&nbsp;<a href="' . base_url($this->session->userdata('admins')['user_type'].'/dashboard') . '" class="btn btn-danger">Cancel</a>';
                                ?>
                                </div>
                            </div>
                        </div>
