            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6 mobiledesign">
                    <div class="small-box bg-warning">
                        ...
                        <a href="<?php echo base_url($this->session->userdata('admins')['user_type']. '/ticket/servicelist/?status=10'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
				<div class="col-lg-3 col-6 mobiledesign">
                    <div class="small-box bg-success">
                        ...
                        <a href="<?php echo base_url($this->session->userdata('admins')['user_type']. '/ticket/servicelist/?status=20'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6 mobiledesign">
                    <div class="small-box bg-danger">
                        ...
                        <a href="<?php echo base_url($this->session->userdata('admins')['user_type']. '/ticket/servicelist/?status=90'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
