            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview <?php echo (in_array($uri_segment, array('ticket')) ? $menu_open : ''); ?>">
                    <a href="#" class="nav-link">
                        ...
                        <p>Ticket <i class="fa fa-angle-left right"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                ...
                <li class="nav-item has-treeview <?php echo (in_array($uri_segment, array('category', 'state')) ? $menu_open : ''); ?>">
                    <a href="#" class="nav-link">
                        ...
                        <p>Category Management <i class="fa fa-angle-left right"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                ...
                <li class="nav-item has-treeview <?php echo (in_array($uri_segment, array('expertise')) ? $menu_open : ''); ?>">
                ...
                <li class="nav-item has-treeview <?php echo (in_array($uri_segment, array('setting')) ? $menu_open : ''); ?>">
                    <a href="#" class="nav-link">
                        ...
                        <p>Setting<i class="fa fa-angle-left right"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
