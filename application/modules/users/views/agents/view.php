                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button class="back-btn btn btn-info white-icon" onclick="window.history.back();" style="float:right;"><i class="fa fa-arrow-left" ></i> Back</button>
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
							<?php if(!empty($row->account_type)){ ?>
								<div class="col-4">
									...
									<h5>Account Type</h5>
									<p><?php if($row->account_type == 'freelancer'){
										echo 'Freelancer';
									}else{
									  echo 'Agency';
									} ?></p>
							...
							?>
								<div class="col-4">
									<div class="ticketmanagement">
									<h5>City</h5>
									<p><?php echo !empty($cityquery->city_name)?$cityquery->city_name:'NA'; ?></p>
									</div>                               
								</div>
							<?php } ?>
                            </div>
                        ...
                        <div class="card-body">
							...
							<?php 
								if(!empty($row->category_id)){
									$categoryData = $this->category_model->get_category_data($row->category_id);
							?>
								<div class="col-4">
									<div class="ticketmanagement">
										<h5>Category Name</h5>
										<p><?php echo !empty($categoryData->name)?$categoryData->name:'NA'; ?></p>
									</div>								  
								</div>
                            <?php }
								if(!empty($row->subcategory_id)){
									$categoryData = $this->category_model->get_category_data($row->subcategory_id);
							?>
								<div class="col-4">
									<div class="ticketmanagement">
