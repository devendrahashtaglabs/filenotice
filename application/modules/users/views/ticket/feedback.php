            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body manage-listd">
                        ...
                        <table id="feedback_table_id" class="table table-bordered table-striped" style="margin-top: 20px;">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Consultant</th>
                            ...
                            ?>
                                ...
                                <?php
									...
									foreach ($tickets['data'] as $row) {
										$ratingdata = $this->ticket_model->getcustomerfeedback($row->ticket_id,$row->customer_id);
										if(!empty($ratingdata)){
											$review 	= !empty($ratingdata->review)?$ratingdata->review:'';
										}else{
											$review 	= '';
										}
										$subcategorydata = $this->category_model->get_category_data($row->subcategory_id);
                                ?>
                                    <tr>
                                        <td><?php echo $a; ?></td>
                                        ...
                                        <td><?php echo $subcategorydata->name; ?></td>
										...
										<td style="display:none;"><?php echo !empty($rating[0])?$rating[0]->rating:'0'; ?></td>
                                    </tr>
                                    <?php $a++;
                                } ?>
                            </tbody>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    foreach($tickets as $row){
										...
										$subcategorydata = $this->category_model->get_category_data($ticketData->subcategory_id);
                                ?>
