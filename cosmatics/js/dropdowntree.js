...
(function($, window, document, undefined) {
    ...
    ComboTree.prototype.init = function() {
        ...
        this._elemArrowBtn = $('<div id="' + this.comboTreeId + 'ArrowBtn" class="comboTreeArrowBtn" type="button"><i class="fa fa-chevron-down comboTreeArrowBtnImg"></i></div>');
    ...
    ComboTree.prototype.createSourceItemHTML = function(sourceItem) {
        ...
        if (isThereSubs)
            itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '<i class="fa fa-chevron-right"></i>' : '<i class="fa fa-chevron-down"></i>') + '</span>'; // itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '+' : '&minus;') + '</span>';
    ...
    ComboTree.prototype.toggleSelectionTree = function(item, direction) {
        ...
        if (direction === undefined) {
            if ($(subMenu).is(':visible'))
                $(item).children('span.comboTreeParentPlus').html('<i class="fa fa-chevron-right"></i>'); //$(item).children('span.comboTreeParentPlus').html("+");
            else
                $(item).children('span.comboTreeParentPlus').html('<i class="fa fa-chevron-down"></i>'); //$(item).children('span.comboTreeParentPlus').html("&minus;");
    ...
    ComboTree.prototype.refreshInputVal = function() {
        ...
        if (this.options.hiddeninput) {
            //console.log(tempids); //return false;
            $(this.options.hiddeninput).val(tempids)
    ...
    ComboTree.prototype.getSelectedIds = function() {
        if (this.options.isMultiple && this._selectedItems.length > 0) {
			...
			$('#getids').val(this._selectedItem.id);
